...
const trekkingSchema = new mongoos.Schema({
  Name: {
    type: String,
    required: [true, 'Please Enter Trekking Name !'],
  },
  Place: {
    type: String,
    required: [true, 'Please Enter Trekking Place !'],
  },
  Country: {
    type: String,
    required: [true, 'Please Enter Trekking country !'],
  },
  State: {
    type: String,
    required: [true, 'Please Enter Trekking State !'],
  },
  City: {
    type: String,
    required: [true, 'Please Enter Trekking City !'],
  },
  Description: {
    type: String,
